  ...
  const uploadFiles = async () => {
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "Success!",
        text: `${result.data.length} file(s) uploaded successfully!`,
        timer: 1500,
        ...
        didOpen: () => {
          // Ensure SweetAlert appears above the dialog
      ...
      // Note: No need to refresh projects list here - files are already updated locally
    } catch (err) {
